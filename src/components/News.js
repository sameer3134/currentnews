...
const News = (props)=>{
    ...
    const updateNews = async ()=> {
        ...
        const link = `https://newsdata.io/api/1/news?apikey=pub_3469f7386261b52062b0ee381ebd74a7ccc0&country=${props.country}&language=en&category=${props.category}&page=${page}`; 
        setLoading(true)
